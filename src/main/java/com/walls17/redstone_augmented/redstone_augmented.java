...
import com.walls17.redstone_augmented.init.redstone_augmented_blocks;
...
public class redstone_augmented
{
    ...
    public redstone_augmented() {
        ...
        redstone_augmented_blocks.BLOCKS.register(FMLJavaModLoadingContext.get().getModEventBus());
